<!-- agregar los url de la aplicacion en forma dinamico
     para no cambiar toda la url del  href="/empleados" href="/empleados/agregar"
     solo ponemos "urlInicio"  en href="urlInicio" con llaves
-->
